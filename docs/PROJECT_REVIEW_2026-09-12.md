...
2. **Superseded source trees and repair payloads were reintroduced.** The old `com.example.demo_ai_even` Android package, response-authority patch drivers, G7 fixture archives and one-shot vector/product scripts were removed. Canonical Android sources remain under `org.trillionnium.heptaglasses`.
