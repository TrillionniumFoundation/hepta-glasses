...
void main() {
  test(
    'BMP transfer rejects invalid input before touching transport',
    () async {
      var sends = 0;
      ...
      expect(
        await manager.updateBmp('X', Uint8List.fromList(<int>[1])),
        isFalse,
      );
  ...
  test(
    'BMP transfer frames packets and validates both acknowledgements',
    () async {
  ...
  test(
    'BMP transfer does not replay an indeterminate finish command',
    () async {
