...
def install_snapshot_io(core: ModuleType) -> None:
    ...
    def safe_scoped_path(
        ...
        *,
        ...
        # the final path to exist; validation reads remain strict.
        ...
        # Pin its stable bytes immediately under the lexical path identity so a
        # symlink cannot be retargeted between path selection and a later hash,
        # parse, secret scan, key check, or signature verification.
